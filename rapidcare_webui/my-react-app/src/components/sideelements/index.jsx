      ...
      <li>
        ...
        <ul id="dropdown-example" className="hidden py-2 space-y-2">
          <li>
            <a
              href="#"
              className="flex items-center w-full p-2 text-purple-900 transition duration-75 rounded-lg pl-11 group hover:bg-purple-100 dark:text-white dark:hover:bg-purple-700"
            >
              Customers
            </a>
          </li>
